...
* Moon position, size and orbit size are not connected to real coordinates yet.  Anyway, Moon revolution at 27.32 days, is so much faster than the other celestial objects, it is just all over the place when animated.  Fake. (TODO)
